package proje342;
	...
	public ArrayList<Campaign> kampanya =new ArrayList<Campaign>();
	...
	public ArrayList<StaffGrade> staffgradeList =new ArrayList<StaffGrade>();
		...
		public  Database(String title,String startDate) {  //campaign 
			
			kampanya.add(new Campaign("abc","10/10/2018","10/01/2019",2.1,2.1));
			kampanya.add(new Campaign("abc","10/10/2018","10/01/2019",2.1,2.1));
